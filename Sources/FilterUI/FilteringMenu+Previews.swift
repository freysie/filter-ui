...
func tableItem(_ name: String) -> NSMenuItem {
  let item = NSMenuItem()
...
func procedureItem(_ name: String) -> NSMenuItem {
  let item = NSMenuItem()
...
func columnItem(_ name: String, type: String) -> NSMenuItem {
  let item = NSMenuItem()
...
let tableColor = NSColor(calibratedRed: 87/255, green: 113/255, blue: 146/255, alpha: 1)
